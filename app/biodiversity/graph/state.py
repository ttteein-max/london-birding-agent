...
class BiodiversityAgentState(TypedDict, total=False):
    ...
    geocoded_location_candidates: NotRequired[list[dict[str, Any]]]
    geocoding_provenance: NotRequired[dict[str, Any] | None]
    selected_geocoded_location: NotRequired[dict[str, Any] | None]
