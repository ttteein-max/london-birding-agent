...
export const walkingPlanFixture: NonNullable<FinalPlanView["walking_plan"]> = {
  ...
  outbound_travel_duration_minutes: 60.8,
  return_travel_duration_minutes: 61,
  total_travel_duration_minutes: 121.8,
  ...
  cache_status: "miss",
  selection_rationale: "Selected by deterministic routing code after the evidence, entrance and route constraints passed.",
  historical_execution: false,
  routing_policy_note: null,
  constraint_results: [
